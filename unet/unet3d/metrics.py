...
from unet.unet3d.losses import compute_per_channel_dice
from unet.unet3d.utils import get_logger, adapted_rand, expand_as_one_hot, plot_segm
...
def get_evaluation_metric(config):
    ...
    def _metric_class(class_name):
        m = importlib.import_module('unet.unet3d.metrics')
