...
from unet.unet3d.buildingblocks import Encoder, Decoder, DoubleConv, ExtResNetBlock
from unet.unet3d.utils import number_of_features_per_level
...
def get_model(config):
    def _model_class(class_name):
        m = importlib.import_module('unet.unet3d.model')
